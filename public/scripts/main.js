...
async function onClickSquareBox2() {
    if (incrementer == 1) {
        ...
        document.getElementById("device-lat1").innerHTML ="Current Latitude: "+ currentlat.toFixed(9);
        currentlon = locText.coords.longitude;
        console.log(currentlon)
        document.getElementById("device-long1").innerHTML ="Current Longitude: "+ currentlon.toFixed(9);
        ...
        if (isInside() == true) {
            ...
            document.getElementById("target").innerHTML ="Congratulations!, You found location  "+ questLocationName;
